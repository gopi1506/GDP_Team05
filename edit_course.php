      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Edit Course</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Complete the form to Edit course</p>
                </div>
                <div class="card-body">
                  <form action='edit_course_code.php' method='post' enctype="multipart/form-data">

                  <?php  echo "<input type='hidden' value='".$course_code."' name='course_code' />"; ?>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                         <?php
                            ...
                            echo  "<input type='text' value='".$course_name."' name='course' class='form-control' placeholder='Course Name & Section' required>";
                             }//end of while loop 
                         ?>                 
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                        <?php
                       echo   "<input type='text' value='".$start_link."' class='form-control' name='start' placeholder='Start Survey' />";
                   ?>
                          </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        <?php
                      echo   "<input type='text' value='".$end_link."' class='form-control' name='end' placeholder='End Survey' />";
                  ?>
                          </div>
                    </div>
