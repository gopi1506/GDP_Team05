...
$db = mysqli_connect('localhost', 'root', '', 'gdp') or die('error connecting to mysql db');
   ...
   if ( isset($_FILES["file"])) {
        ...
        if ($_FILES["file"]["error"] > 0) {
           ...
           $query = "insert into codewordset_admin(codewordset_name,codewordset_code,created_at,email,published) values ('$codewordset_name','$codewordset_code','$created_at','$email','$published')";
