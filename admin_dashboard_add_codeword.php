      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Create Codeword set</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Create Codeword Set</h4>
                  <p class="card-category">Complete the form to add create codeword set</p>
                </div>
                <div class="card-body">
                  <form action='admin_add_codeword.php' method='post' enctype="multipart/form-data">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <input type="text" name="codeword" class="form-control" placeholder="Codewordset Name" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
