      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#">Codewordset View</a>
          </div>
      ...
      <div class="content">
		...
		<div class="row">
          ...
          echo $rowcount;
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
             <form action='admin_soft_rules.php' method='post'>
		 ...
		 $query2 = mysqli_query($db, $query) or die('error querying db');
            ...
            <div class='card-body'>
              <div id='typography'>
				...
				<form action='admin_delete_codeword.php' method='post' >
        ...
        <input type='hidden' value='".$codewordset_code."' name='codewordset_code'/>
				...
				echo "<form method='post' action='admin_publish_codeword.php'>
        <input type='hidden' value='".$codewordset_code."' name='codewordset_code'/>
