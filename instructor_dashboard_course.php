            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Complete the form to add course</p>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type='text'  class="form-control" name='date' value="<?php echo $current_date; ?> - <?php echo $final_date; ?>" required/>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                     ...
                     <input type="file" name='file' data-toggle="popover" title="File should be a text file which contains student name and email seperated by ',' in every new line!" data-content="Some content inside the popover" class="form-control inputFileVisible" placeholder="Single File" required>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <input type='text'  class="form-control" name='start' placeholder='Start Survey' />
                     </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                          <input type='text'  class="form-control" name='end' placeholder='End Survey' />
                     </div>
                    </div>
