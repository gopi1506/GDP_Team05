...
<h2 style='color:#fff;padding-top:10px;'>SIGN UP</h2>
</div>
<div class='mini-body'>
...
<input type="checkbox" name="is_instructor" value='Instructor'style='margin:6px 0px 6px 0px;'> Is Instructor?<br>
<input type='submit' value='Sign Up' style='background:#59af50;color:#fff;width:30%;height:8%;margin:6px 0px 6px 0px;'/>
</form>


<a href='login.php' style='text-decoration:none;float:right;'><h4 style='color:#000;margin:0px;padding-right:20px;'>Already have an account?LogIn</h4></a>
